...
<head>
  ...
  <link rel="stylesheet" href="/filemanager/assets/crop/css/main.css">
</head>
<body>
  <!--[if lt IE 9]>
    ...
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="img-container">
          <input type="hidden" name="imageid" value="{{ \Crypt::encryptString($identifier) }}">
          <img id="image" src="{{ $url }}" data-id="{{ \Crypt::encryptString($identifier) }}" alt="Picture">
        </div>
      </div>
      <div class="col-md-3">
        <!-- <h3>Preview:</h3> -->
  ...
  <script src="/filemanager/assets/crop/js/jquery-cropper.js"></script>
  <script src="/filemanager/assets/crop/js/main.js"></script>
</body>
</html>
